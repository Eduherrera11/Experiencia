...
precio_productos = [30,9.8,42.5,32.6,71.5,44,21.2,53.2,25.3,57.8]
unidades_productos = [3,1,0,0,7,2,0,0,4,0]
facturacion_producto = []

total_ventas = sum(unidades_productos)

dinero_total = 0
for i in range(0,len(precio_productos)):
    dinero_por_producto = precio_productos[i]*unidades_productos[i]
...
print("La facturacion por pedido es ", facturacion_producto)
